    ...
    (function (t, e) {
        ...
        o = function () {
            ...
            t.prototype.refresh = function () {
                ...
                this.doScroll();
                t = {horizontal: {
                        contextOffset: r ? 0 : e.left, contextScroll: r ? 0 : this.oldScroll.x, contextDimension: this.$element.width(), oldScroll: this.oldScroll.x, forward: "right", backward: "left", offsetProp: "left"}, vertical: {
                ...
                return n.each(t, function (t, e) {
                    return n.each(i.waypoints[t], function (t, r) {
                        ...
                        if
                                (l !== null && l < (s = e.oldScroll) && s <= r.offset) {
